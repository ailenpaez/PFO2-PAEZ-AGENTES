...
## ⭐Deploy unificado a partir de un Prompt:

Aprovechando la práctica, el menú inicial se realizó mediante un prompt sencillo con la herramienta Claude:

>Creá una portada en HTML y CSS separados para un proyecto universitario llamado CopaTracker 2026. La página debe tener tres accesos directos: un botón que abra un modal con el texto plano del prompt usado, un link a la landing generada por el Agente 1 (Claude Code · Claude Sonnet) y un link a la landing del Agente 2 (Cursor + GitHub Copilot · Composer 2.5 Fast). Usá JetBrains Mono como única tipografía en distintos pesos (100 a 800) para jerarquizar los elementos. La paleta es: #0A2342, #007BFF, #E63946, #00B4D8 y #FFFFFF. El estilo debe ser dark, con grilla de fondo sutil, glow radial y tarjetas con borde izquierdo de color por acento. Las URLs de los deploys son https://pfo-2-paez-agente-claude.vercel.app/ y https://agent-6a3d7c5b65267f2da99890e5--cursorappfixture.netlify.app/.

#### Resultado Final:

![Menú inicial](BRIEF-SCREENS/index.png)
